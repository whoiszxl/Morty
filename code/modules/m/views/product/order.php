		...
		<div class="order_box">
			...
			<ul class="address_list">
				<li style="padding: 5px 5px;">
					<label>
						<input style="display: inline;" type="radio" name="address_id" value="2" checked> 浙江省宁波市海曙区太阳出来了爬山平（whoiszxl收）13774355081 </label>

				</li>
				<li style="padding: 5px 5px;">
					<label>
						<input style="display: inline;" type="radio" name="address_id" value="1"> 天津市河东区狗不理包子100号（whoiszxl收）13774355074 </label>
